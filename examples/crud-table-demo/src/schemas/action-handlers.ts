...
export function setupActionHandlers(actionExecutor: ActionExecutor) {
  ...
  // // 创建用户
  // actionExecutor.registerCustomHandler('act_create_user', async (context: any, record?: any) => {
  ...
  // // 更新用户
  // actionExecutor.registerCustomHandler('act_update_user', async (context: any, record: any) => {
  //   const { stateManager } = context;
  ...
  // // 删除用户
  // actionExecutor.registerCustomHandler('act_delete_user', async (context: any, record: any) => {
  //   const { stateManager } = context;
  ...
  // // 批量删除用户
  // actionExecutor.registerCustomHandler('act_batch_delete_users', async (context: any, records: any[]) => {
  //   const { stateManager } = context;
